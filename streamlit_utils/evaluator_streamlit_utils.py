...
def evaluator_prompts_panel(st):
    ...
    model_options = {'o3': 'o3'} #{'gpt-4-omni': 'gpt-4', 'gpt-3.5': 'gpt-3.5'}
    ...
    try:
        ...
        with st.spinner("Processing Input Files..."):
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                s3_par_url, proposal_text, proposal_summary_text, proposal_summary_prompt = proposal_future.result()
...
def generate_evaluator_comments(st, nature):
    ...
    model_options = {'o3': 'o3'} #{'gpt-4-omni': 'gpt-4', 'gpt-3.5': 'gpt-3.5'}
    selected_display_name = st.selectbox('Evaluate Model', ('o3',))
    model_key = model_options[selected_display_name]
    model = possible_models[model_key]
